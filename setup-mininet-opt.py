...
def setCommand(hnum, hid, sid, wl, bw):
    ...
    if int(host_id) != hnum:
        ...
        cmd_c = cmdHead_c + address_target + ' -p ' + str(port_head+int(host_id)) + ' -n ' + str(communication_loadsize) + 'k' + ' -b ' + str(communication_bandwidth) + 'k' + outputFile_c
    else:
        ...
        cmd_c = cmdHead_c + address_target + ' -p ' + str(port_head+int(host_id)) + ' -n ' + str(communication_loadsize) + '' + ' -b ' + str(communication_bandwidth) + '' + outputFile_c        
...
def setupNetwork(totalHost):
    ...
    raw_input('Press enter to exit...(opt)')
